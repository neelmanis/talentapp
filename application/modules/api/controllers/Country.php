...
class Country extends Generic{
	...
	public function index(){
		...
		if($method !== 'GET'){
			...
			$country_query = 'SELECT country_id, country_name_en, country_name_ar, phonecode, shortname FROM country_master WHERE status=\'active\' ORDER BY country_name_en ASC';		
			$response = $this->Mdl_api->customQuery($country_query);
